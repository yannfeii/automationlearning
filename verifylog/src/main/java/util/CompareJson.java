...
public class CompareJson {
    ...
    public void compareJson(JSONObject jsonObject1, JSONObject jsonObject2, Map<String, Object> objectMap) {
        ...
        if (json1 instanceof JSONObject) {
            ...
            if (jsonArray != null && jsonArray.size() > 0) {
                if (!(jsonArray.get(0) instanceof JSONObject)) { //["1","2"],[1,2]...
                    ...
                    compareMap.put(SysOld, json1);
                    compareMap.put(SysNew, json2);
